...
const styles = StyleSheet.create({
  container: { flex: 1, alignItems: 'center', padding: 24, backgroundColor: '#E8E8E8' },
  ...
  name: { fontSize: 22, fontWeight: 'bold', marginTop: 16, marginBottom: 4, textAlign: 'center', color: '#000' },
